...
const PreviewNav = () => {
	...
	return (
		<nav className='flex justify-between h-auto items-center gap-4 bg-primary-white-light w-full md:px-4 py-2 rounded-lg'>
			...
			{updatingLink ? (
				<button onClick={handleSave} className='border border-primary-button-bg font-[600] rounded-md py-3 md:py-2 bg-primary-button-bg text-primary-white-light flex items-center justify-center w-full md:w-[130px] px-2 text-sm'>
					Save Changes
				</button>
			) : (
				<button onClick={handleUpdate} className='border border-primary-button-bg font-[600] rounded-md py-3 md:py-2 bg-primary-button-bg text-primary-white-light flex items-center justify-center w-full md:w-[120px] px-4 text-sm'>
					Update Links
				</button>
			)}
		</nav>
