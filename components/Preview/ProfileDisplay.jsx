	...
	return (
		<div className='flex md:shadow-lg px-6 box-border py-4 rounded-xl flex-col justify-between  gap-10 w-full'>
			<section className='space-y-2 flex w-full px-4  flex-col items-center'>
				...
				<p className={`flex-nowrap flex flex-col justify-center text-dark-grey-color-light text-lg items-center rounded-lg h-4 w-full font-bold truncate px-1 ${!user?.firstName && 'bg-profile-image-bg'}  ${userLoading && 'shimmer'}`}>{fullName}</p>
